...
// Tue Jun 12 12:51:44 2018 by ROOT version 6.08/06
// from TTree HTauTauTree/small tree for HH analysis
// found on file: TT_fullyLep.root
//////////////////////////////////////////////////////////

#ifndef fullyLepBG_analysis_h
#define fullyLepBG_analysis_h
...
class fullyLepBG_analysis : public TSelector {
public :
   TTreeReader     fReader;  //!the tree reader
   TTree          *fChain = 0;   //!pointer to the analyzed TTree or TChain

   // Readers to access the data (delete the ones you do not need).
   TTreeReaderValue<Float_t> MC_weight = {fReader, "MC_weight"};
   TTreeReaderValue<Float_t> PUReweight = {fReader, "PUReweight"};
   TTreeReaderValue<Float_t> bTagweightL = {fReader, "bTagweightL"};
   TTreeReaderValue<Float_t> bTagweightM = {fReader, "bTagweightM"};
   TTreeReaderValue<Float_t> bTagweightT = {fReader, "bTagweightT"};
   TTreeReaderValue<Float_t> TTtopPtreweight = {fReader, "TTtopPtreweight"};
   TTreeReaderValue<Float_t> TTtopPtreweight_up = {fReader, "TTtopPtreweight_up"};
   TTreeReaderValue<Float_t> TTtopPtreweight_down = {fReader, "TTtopPtreweight_down"};
   TTreeReaderValue<Float_t> turnOnreweight = {fReader, "turnOnreweight"};
   TTreeReaderValue<Float_t> turnOnreweight_tauup = {fReader, "turnOnreweight_tauup"};
   TTreeReaderValue<Float_t> turnOnreweight_taudown = {fReader, "turnOnreweight_taudown"};
   TTreeReaderValue<Float_t> trigSF = {fReader, "trigSF"};
   TTreeReaderValue<Float_t> IdAndIsoSF = {fReader, "IdAndIsoSF"};
   TTreeReaderValue<Float_t> DYscale_LL = {fReader, "DYscale_LL"};
   TTreeReaderValue<Float_t> DYscale_MM = {fReader, "DYscale_MM"};
   TTreeReaderValue<Int_t> nBhadrons = {fReader, "nBhadrons"};
   TTreeReaderValue<Int_t> lheNOutPartons = {fReader, "lheNOutPartons"};
   TTreeReaderValue<Int_t> lheNOutB = {fReader, "lheNOutB"};
   TTreeReaderValue<ULong64_t> EventNumber = {fReader, "EventNumber"};
   TTreeReaderValue<Int_t> RunNumber = {fReader, "RunNumber"};
   TTreeReaderValue<Int_t> isBoosted = {fReader, "isBoosted"};
   TTreeReaderValue<Int_t> genDecMode1 = {fReader, "genDecMode1"};
   TTreeReaderValue<Int_t> genDecMode2 = {fReader, "genDecMode2"};
   //TTreeReaderValue<Float_t> m_genMHH = {fReader, "genMHH"};
   //TTreeReaderValue<Float_t> m_genCosth = {fReader, "genCosth"};
   TTreeReaderValue<Int_t> npv = {fReader, "npv"};
   TTreeReaderValue<Float_t> npu = {fReader, "npu"};
   TTreeReaderValue<Int_t> lumi = {fReader, "lumi"};
   TTreeReaderValue<Long64_t> triggerbit = {fReader, "triggerbit"};
   TTreeReaderValue<Int_t> L3filter1 = {fReader, "L3filter1"};
   TTreeReaderValue<Int_t> L3filterlast1 = {fReader, "L3filterlast1"};
   TTreeReaderValue<Int_t> L3filter2 = {fReader, "L3filter2"};
   TTreeReaderValue<Int_t> L3filterlast2 = {fReader, "L3filterlast2"};
   TTreeReaderValue<Float_t> rho = {fReader, "rho"};
   TTreeReaderValue<Int_t> pairType = {fReader, "pairType"};
   TTreeReaderValue<Int_t> isMC = {fReader, "isMC"};
   TTreeReaderValue<Int_t> isOS = {fReader, "isOS"};
   TTreeReaderValue<Float_t> met_phi = {fReader, "met_phi"};
   TTreeReaderValue<Float_t> met_et = {fReader, "met_et"};
   TTreeReaderValue<Float_t> met_et_corr = {fReader, "met_et_corr"};
   TTreeReaderValue<Float_t> met_cov00 = {fReader, "met_cov00"};
   TTreeReaderValue<Float_t> met_cov01 = {fReader, "met_cov01"};
   TTreeReaderValue<Float_t> met_cov10 = {fReader, "met_cov10"};
   TTreeReaderValue<Float_t> met_cov11 = {fReader, "met_cov11"};
   TTreeReaderValue<Float_t> mT1 = {fReader, "mT1"};
   TTreeReaderValue<Float_t> mT2 = {fReader, "mT2"};
   TTreeReaderValue<Float_t> dau1_iso = {fReader, "dau1_iso"};
   TTreeReaderValue<Int_t> dau1_MVAiso = {fReader, "dau1_MVAiso"};
   TTreeReaderValue<Int_t> dau1_CUTiso = {fReader, "dau1_CUTiso"};
   TTreeReaderValue<Int_t> dau1_antiele = {fReader, "dau1_antiele"};
   TTreeReaderValue<Int_t> dau1_antimu = {fReader, "dau1_antimu"};
   TTreeReaderValue<Float_t> dau1_photonPtSumOutsideSignalCone = {fReader, "dau1_photonPtSumOutsideSignalCone"};
   TTreeReaderValue<Bool_t> dau1_byLooseCombinedIsolationDeltaBetaCorr3Hits = {fReader, "dau1_byLooseCombinedIsolationDeltaBetaCorr3Hits"};
   TTreeReaderValue<Bool_t> dau1_byMediumCombinedIsolationDeltaBetaCorr3Hits = {fReader, "dau1_byMediumCombinedIsolationDeltaBetaCorr3Hits"};
   TTreeReaderValue<Bool_t> dau1_byTightCombinedIsolationDeltaBetaCorr3Hits = {fReader, "dau1_byTightCombinedIsolationDeltaBetaCorr3Hits"};
   ...
   TTreeReaderValue<Float_t> dau2_iso = {fReader, "dau2_iso"};
   TTreeReaderValue<Int_t> dau2_MVAiso = {fReader, "dau2_MVAiso"};
   TTreeReaderValue<Int_t> dau2_CUTiso = {fReader, "dau2_CUTiso"};
   TTreeReaderValue<Int_t> dau2_antiele = {fReader, "dau2_antiele"};
   TTreeReaderValue<Int_t> dau2_antimu = {fReader, "dau2_antimu"};
   TTreeReaderValue<Float_t> dau2_photonPtSumOutsideSignalCone = {fReader, "dau2_photonPtSumOutsideSignalCone"};
   TTreeReaderValue<Bool_t> dau2_byLooseCombinedIsolationDeltaBetaCorr3Hits = {fReader, "dau2_byLooseCombinedIsolationDeltaBetaCorr3Hits"};
   TTreeReaderValue<Bool_t> dau2_byMediumCombinedIsolationDeltaBetaCorr3Hits = {fReader, "dau2_byMediumCombinedIsolationDeltaBetaCorr3Hits"};
   TTreeReaderValue<Bool_t> dau2_byTightCombinedIsolationDeltaBetaCorr3Hits = {fReader, "dau2_byTightCombinedIsolationDeltaBetaCorr3Hits"};
   ...
   TTreeReaderValue<Float_t> bjets_bID = {fReader, "bjets_bID"};
   ...
   TTreeReaderValue<Float_t> fatjet_bID = {fReader, "fatjet_bID"};
   ...
   TTreeReaderValue<Float_t> HT20 = {fReader, "HT20"};
   TTreeReaderValue<Float_t> HT50 = {fReader, "HT50"};
   TTreeReaderValue<Float_t> HT20Full = {fReader, "HT20Full"};
   ...
   TTreeReaderValue<Float_t> dau1_z = {fReader, "dau1_z"};
   TTreeReaderValue<Float_t> dau2_z = {fReader, "dau2_z"};
   TTreeReaderValue<Float_t> bjet1_z = {fReader, "bjet1_z"};
   TTreeReaderValue<Float_t> bjet2_z = {fReader, "bjet2_z"};
   TTreeReaderValue<Float_t> tauH_z = {fReader, "tauH_z"};
   TTreeReaderValue<Float_t> bH_z = {fReader, "bH_z"};
   TTreeReaderValue<Float_t> HH_z = {fReader, "HH_z"};
   TTreeReaderValue<Float_t> HH_zV = {fReader, "HH_zV"};
   TTreeReaderValue<Float_t> HH_A = {fReader, "HH_A"};
   ...
   TTreeReaderValue<Float_t> top_Wc_bclose_mass = {fReader, "top_Wc_bclose_mass"};
   TTreeReaderValue<Float_t> top_Wc_bcentral_mass = {fReader, "top_Wc_bcentral_mass"};
   TTreeReaderValue<Float_t> top_Wc_bforward_mass = {fReader, "top_Wc_bforward_mass"};
   TTreeReaderValue<Float_t> top_Wf_bclose_mass = {fReader, "top_Wf_bclose_mass"};
   TTreeReaderValue<Float_t> top_Wf_bcentral_mass = {fReader, "top_Wf_bcentral_mass"};
   TTreeReaderValue<Float_t> top_Wf_bforward_mass = {fReader, "top_Wf_bforward_mass"};
   TTreeReaderValue<Float_t> top_Wmass_bclose_mass = {fReader, "top_Wmass_bclose_mass"};
   TTreeReaderValue<Float_t> top_Wjj_b_mass = {fReader, "top_Wjj_b_mass"};
   TTreeReaderValue<Float_t> top_Wjj_bclose_mass = {fReader, "top_Wjj_bclose_mass"};
   ...
   TTreeReaderValue<Float_t> MuTauKine = {fReader, "MuTauKine"};
   TTreeReaderValue<Float_t> ETauKine = {fReader, "ETauKine"};
   TTreeReaderValue<Float_t> LepTauKine = {fReader, "LepTauKine"};
   TTreeReaderValue<Float_t> BDTResonant = {fReader, "BDTResonant"};
   TTreeReaderValue<Float_t> BDTResonantHM = {fReader, "BDTResonantHM"};
   TTreeReaderValue<Float_t> BDTResonantLM = {fReader, "BDTResonantLM"};
   TTreeReaderValue<Float_t> BDTNonResonant = {fReader, "BDTNonResonant"};


   fullyLepBG_analysis(TTree * /*tree*/ =0) { }
   virtual ~fullyLepBG_analysis() { }
   ...
   ClassDef(fullyLepBG_analysis,0);

};

#endif

#ifdef fullyLepBG_analysis_cxx
void fullyLepBG_analysis::Init(TTree *tree)
{
...
Bool_t fullyLepBG_analysis::Notify()
{
...
#endif // #ifdef fullyLepBG_analysis_cxx
