...
// Tue Jun 12 15:40:38 2018 by ROOT version 6.08/06
// from TTree HTauTauTree/small tree for HH analysis
// found on file: TT_semiLep.root
//////////////////////////////////////////////////////////

#ifndef semiLepBG_analysis_h
#define semiLepBG_analysis_h
...
class semiLepBG_analysis : public TSelector {
public :
   ...
   semiLepBG_analysis(TTree * /*tree*/ =0) { }
   virtual ~semiLepBG_analysis() { }
   ...
   ClassDef(semiLepBG_analysis,0);

};

#endif

#ifdef semiLepBG_analysis_cxx
void semiLepBG_analysis::Init(TTree *tree)
{
...
Bool_t semiLepBG_analysis::Notify()
{
...
#endif // #ifdef semiLepBG_analysis_cxx
